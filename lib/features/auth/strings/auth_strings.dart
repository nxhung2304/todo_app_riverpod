...
class AuthStrings {
  ...
  static String get dontHaveAnAccount => "auth.login.dont_have_an_account".tr();
  
  // Signup
  static String get google => "auth.login.google".tr();
  static String get signupSuccess => "auth.signup.success".tr();
}
